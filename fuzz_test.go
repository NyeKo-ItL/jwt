...
func FuzzParse(f *testing.F) {
	...
	seed, _ := Sign(appClaims{RegisteredClaims: RegisteredClaims{Subject: "seed"}}, signer)
	f.Add(seed)
	f.Add("")
	f.Add("a.b.c")
	f.Add("....")
...
func FuzzDecryptClaims(f *testing.F) {
	...
	seed, _ := EncryptClaims(appClaims{RegisteredClaims: RegisteredClaims{Subject: "seed"}}, enc)
	f.Add(seed)
	f.Add("")
	f.Add("a.b.c.d.e")
